// New Relic Browser monitoring script for real user monitoring (RUM) and custom attributes for WTH O11y-Party game
...
function RecordTeamScore(team, score) {
    // newrelic.setCustomAttribute('WTHTriviaChallengeTeam', team);
    // newrelic.setCustomAttribute('WTHTriviaChallengeTeamScore', score);
}